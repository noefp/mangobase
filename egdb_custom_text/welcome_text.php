      ...
      <p>
        Mango is one of the top five fruit crops worldwide in terms of production (more than 55 million tons in 2018), after bananas, apples, grapes and oranges. Mangoes are an important fruit crop grown in over 103 countries across the tropical and subtropical zones. The common mango is typically a large, tropical, and evergreen tree with an upright to spreading dense canopy that can reach up to 30 m in some climates if not pruned. India is by far the largest mango producer with 41.6% of world production (18 Mt) followed by China with 10% (4.5 Mt).
			</p>
			<center>
