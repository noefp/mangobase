<div class="width900">
  ...
  <div class="list-group">
    ...
    <a href="/downloads/PDFs/Mango-Booklet-English.pdf" class="list-group-item list-group-item-action"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Training and pruning the mango tree</a>
    <a href="/downloads/PDFs/mango_guia_plagas.pdf" class="list-group-item list-group-item-action"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Guía de gestión integrada de plagas de mango</a>
  </div>
</div>